...
def train_and_log_from_mongodb():
    ...
    mlflow.set_tracking_uri("https://dagshub.com/sksivakumar726/CICD_Wind.mlflow")  # << Change this
    ...
    with mlflow.start_run() as run:
        ...
        try:
            ...
            client.create_registered_model("WindPowerPredictor")
        except mlflow.exceptions.RestException:
            # Model already exists
            pass

        # Register this run's model version
